...
class RegistrationManager(models.Manager):
	...
	def create_inactive_user(self, username, password, email,
							send_email=False, expires=True, profile_callback=None):
		"""
		...
		registration_profile = self.create_profile(new_user, expires)
	...
	def create_profile(self, user, expires):
		"""
		...
		return self.create(user=user, expires=expires,
